...
if __name__ == '__main__':
    ...
    # global_keyframes_pose = torch.tensor([[-0.8503151535987854, 0.010112131014466286, -0.5261768102645874, 0.07931490987539291], 
    #                                         [-0.0051340628415346146, 0.9996084570884705, 0.027507375925779343, -0.003034725785255432], 
    #                                         [0.5262489318847656, 0.026091359555721283, -0.8499302268028259, 0.08693282306194305], 
    #                                         [0.0, 0.0, 0.0, 1.0]])

    # local_keyframes_pose = torch.tensor([[0.9757914543151855, -0.023805633187294006, 0.21740348637104034, -0.0191758144646883], 
    #                                     [0.021295156329870224, 0.9996768236160278, 0.013883441686630249, -0.003477656515315175], 
    #                                     [-0.2176637202501297, -0.008917702361941338, 0.9759830832481384, 0.24745528399944305], 
    #                                     [0.0, 0.0, 0.0, 1.0]])
    pcd_center = train_dataset.get_center()
    # instance model
    
    # only  optimizer scale 
    # model = Model(global_keyframes_pose, local_keyframes_pose, pcd_center)

    # delta model : optimizer scale, R, t
    # init_pose =  global_keyframes_pose @ torch.inverse(local_keyframes_pose)
    model = sRT_Optimizer()
